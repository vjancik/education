...
- Letters are scored as in Scrabble; A is worth 1, B is worth 3, C is worth 3, D is worth 2, E is worth 1, and so on. We have defined the dictionary SCRABBLE\_LETTER\_VALUES that maps each lowercase letter to its Scrabble letter value.
...
getWordScore, updateHand, isValidWord, calculateHandlen, playHand, playGame, compChooseWord, compPlayHand, playGame
